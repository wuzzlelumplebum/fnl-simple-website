...
$id = $_GET['id'];
$sql = "SELECT u.id, u.first_name, u.last_name, u.email, u.role_id, r.role
FROM users u
...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="row">
            <h2 style="margin-top: 15px; text-align: center;">User Details</h2>
            <dl class="row">
                <dt class="col-sm-3">User First Name</dt>
                <dd class="col-sm-9"><?php echo $row['first_name']; ?></dd>
                <dt class="col-sm-3">User Last Name</dt>
                ...
                <dd class="col-sm-9"><?php echo $row['role']; ?></dd>
            </dl>
            <div class="col-6">
                <div class="mb-3">

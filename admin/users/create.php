...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO users (first_name, last_name, email, password, role_id) VALUES ('$first_name','$last_name','$email','$password','$role')";
    $result = mysqli_query($conn, $query);

    if($result){
        echo "<script>alert('User added successfully.'); window.location.href = 'index.php';</script>";
    } else {
        echo "<script>alert('Failed to add user.'); window.location.href = 'create.php';</script>";
    }
}
?>
            ...
            <form action="" method="post" style="width:50vw; min-width:300px;" enctype="multipart/form-data">
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="first_name" placeholder="User First Name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">User Last Name</label>
                        <input type="text" class="form-control" name="last_name" placeholder="User Last Name" required>
                    </div>
                    <div class="mb-3">

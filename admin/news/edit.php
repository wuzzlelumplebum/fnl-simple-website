...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE news SET title='$title', date='$date', description='$description', image_path='$newfilename' WHERE id = '$id'";
    // $result = mysqli_query($conn, $query);

    if(mysqli_query($conn, $query)){
        echo "<script>alert('News edited successfully.'); window.location.href = 'index.php';</script>";
    } else {
        echo "<script>alert('Failed to edit news.'); window.location.href = 'edit.php';</script>";
    }
}
?>
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Complete the form below to edit a news details</p>
        </div>
        <?php 
            $id = $_GET['id'];
            ...
            <form action="" method="post" style="width:50vw; min-width:300px;" enctype="multipart/form-data">
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="News Title" value="<?php echo $row['title'] ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="description" placeholder="News Description" value="<?php echo $row['description'] ?>" required>
                    </div>
                    <div class="mb-3">

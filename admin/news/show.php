...
<body>
    ...
    <div class="row ">
            <div class="col-6">
                <img src="../../assets/img/news/<?php echo $row['image_path']; ?>" alt="" width="100%">
            </div>
            <div class="col-6">
                <h2><?php echo $row['title']; ?></h1> <br>
                <div class="mb-3">
                    <label class="form-label" style="font-weight: bold; font-size: 25px;">News Date</label>
                    <p><?php $formattedDate = date("d F Y", strtotime($row['date'])); echo $formattedDate; ?></p>
                </div>
                <div class="mb-3">
                    <label class="form-label" style="font-weight: bold; font-size: 25px;">News Description</label>

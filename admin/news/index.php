                    ...
                    if($result && mysqli_num_rows($result) > 0){
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../../assets/img/news/<?php echo $row['image_path']; ?>" alt="" width="100%" height="200px"></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a onclick="return confirm('Are you sure you want to delete this category?')" href="delete.php?id=<?php echo $row['id'] ?>" class="dropdown-item link-dark">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>

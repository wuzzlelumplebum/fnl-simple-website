...
<body>
    ...
    <div class="container">
        ...
        <br>
        <a href="create.php" class="btn btn-success mb-3">Add Reviews</a>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                <?php 
                    $sql = "SELECT r.id AS review_id, r.review, r.user_id, u.id, u.first_name, u.last_name
                    FROM reviews r
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="show.php?id=<?php echo $row['review_id'] ?>" class="dropdown-item link-dark">Show</a></li>
                                            <li><a href="edit.php?id=<?php echo $row['review_id'] ?>" class="dropdown-item link-dark">Edit</a></li>
                                            <li><a onclick="return confirm('Are you sure you want to delete this review?')" href="delete.php?id=<?php echo $row['review_id'] ?>" class="dropdown-item link-dark">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>

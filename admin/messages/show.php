...
$sql = "SELECT sm.id, m.message, u.first_name, u.last_name
        ...
        INNER JOIN users u ON sm.user_id = u.id WHERE sm.id = $id";
...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="row">
            <h2 style="margin-top: 15px; text-align: center;">Customer Message Details</h2>
            <dl class="row">
                ...
                <dd class="col-sm-9"><?php echo $row['message']; ?></dd>
            </dl>
            <div class="col-6">
                <div class="mb-3">

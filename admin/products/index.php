...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                <?php 
                    $sql = "SELECT p.id, p.code, p.name, p.image_path, c.category, s.status
                     FROM products p
                    ...
                    if($result && mysqli_num_rows($result) > 0){
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../../assets/img/products/<?php echo $row['image_path']; ?>" alt="" width="200px" height="200px"></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a onclick="return confirm('Are you sure you want to delete this product?')" href="delete.php?id=<?php echo $row['id'] ?>" class="dropdown-item link-dark">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
